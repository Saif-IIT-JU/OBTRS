...
<div class="row">
  <div class="column" style="background-color:#aaa;">
    <img src="bus2.jpg" alt="LOGO" width="800" height="680">
  </div>
  <div class="column" style="background-color:#bbb;">
    <h1 style="text-align: center">Make your reservation</h1>

  <form action="bus reservation2.php" method="post" name="myForm" onsubmit="return validateForm()">
    ...
    <div class="input-field2">
      ...
      <input class="input-field" type="text" name="contact" required placeholder="Ex:- 01XXXXXXXXX"><br>
    </div>

    <div class="input-field2">
      <label class="input-field3">Email </label><br>
      <input class="input-field" type="email" name="email" required><br>
    </div>

    <div class="input-field2">
      <label class="input-field3">Address </label><br>
      <input class="input-field" type="text" name="address" required><br>
    </div>
    ...
    <div class="input-field2">
      <label class="input-field3">Number of buses(AC)</label><br>
      <input class="input-field" type="text" name="ac_cnt" required placeholder="ex: 3 (if no need enter 0)"><br>
    </div>

    <div class="input-field2">
      <label class="input-field3">Number of buses(NON-AC)</label><br>
      <input class="input-field" type="text" name="non_ac_cnt" required placeholder="ex: 3 (if no need enter 0)"><br>
    </div>

    <p style="text-align: center;"><input type="submit" value="Confirm"></p><br>
